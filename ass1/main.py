...
def zweia(model_name,
    ...
    model_train_and_eval(model_name=model_name,
...
if __name__ == '__main__':
    ...
    images, labels = data_preloading(dataset_path)
    ...
    print("data[labels]")
    #print(data)
    full_dataset = ImageDataset(images=images,
                                labels=labels, transform_type=transform_type)
    train_size = int(0.6 * len(full_dataset))
    val_size = len(full_dataset) - train_size
